...
A subagent does not receive this rule, so a delegation prompt must carry it. When you ask a subagent to write or edit prose, put the constraint in the prompt: one line per paragraph, never hard-wrapped.
